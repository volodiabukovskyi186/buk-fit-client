...
import { HS_SELECT_PARENT_COMPONENT, HSSelectParentComponent } from '../text-select-parent.component';

@Component({
  selector: 'hs-text-select-option-all',
  templateUrl: './text-select-option-all.component.html',
  styleUrls: ['./text-select-option-all.component.scss'],
