...
export class ButtonToggleGroupDirective implements ControlValueAccessor {
  ...
  @HostBinding('class.hs-button-toggle-group-container')
  get toggleButtonGroupContainer(): boolean {
    return true;
  }

  @HostBinding('class.hs-button-toggle-group-disabled')
  get toggleGroupDisabledClass(): boolean {
    return this.disabled;
  }

  @HostBinding('class.hs-button-toggle-group-inverted')
  get toggleGroupInvertedClass(): boolean {
    return this.inverted;
  }

  @HostBinding('class.hs-button-toggle-group-icons')
